...
const Korpana = () => {
  const titleText = useText('Korpana Latest News');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <aside className="lg:col-span-4">
            <div className="lg:sticky lg:top-24 space-y-8">
              <AdRenderer placement="sidebar" fallbackIndex={8} />
              <TrendingNewsSidebar />
            </div>
          </aside>
        </div>
        <div className="mt-12 flex justify-center">
          <AdRenderer placement="footer" fallbackIndex={9} />
        </div>
      </div>
    </main>
  );
